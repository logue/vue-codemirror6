import{h as U,d as w,r as h,c as j,w as b,o as B,n as E,a as O,t as A,b as S,e as t,f as p,g as v,i as z,v as D,j as u,k,l as V,m as M,p as N}from"./vue.7dc6131d.js";import{l as y}from"./lodash.0a8ed3d0.js";import{E as f,b as H,m as J,k as R,i as F,a as L,l as G,c as I,S as W,d as x,e as P,h as K,j as Y,f as Q}from"./codemirror.4ca7bb13.js";import{z as X}from"./linter.4d0ec9e4.js";const Z=function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function o(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerpolicy&&(i.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?i.credentials="include":n.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(n){if(n.ep)return;n.ep=!0;const i=o(n);fetch(n.href,i)}};Z();const ee=e=>e?Object.entries(e).reduce((a,[o,r])=>(o=o.charAt(0).toUpperCase()+o.slice(1),o=`on${o}`,{...a,[o]:r}),{}):null,C=(e,a={},o)=>{const{props:r,domProps:n,on:i,...l}=a,c=i?ee(i):{};return U(e,{...l,...r,...n,...c},o)},te=e=>typeof e=="function"?e():e;var $=w({name:"CodeMirror",model:{prop:"modelValue",event:"update:modelValue"},props:{modelValue:{type:String,default:""},theme:{type:Object,default:()=>({})},dark:{type:Boolean,default:!1},basic:{type:Boolean,default:!1},minimal:{type:Boolean,default:!1},wrap:{type:Boolean,default:!1},tab:{type:Boolean,default:!1},readonly:{type:Boolean,default:!1},editable:{type:Boolean,default:!0},extensions:{type:Array,default:()=>[]},phrases:{type:Object,default:()=>{}},lang:{type:Object,default:()=>{}},linter:{type:Function,default:()=>{}},lintGutter:{type:Boolean,defalt:!1}},emits:["update:modelValue","update:view"],setup(e,a){const o=h(),r=h(e.modelValue);let n;const i=j({get:()=>n.state.selection.main.head||0,set:s=>n.dispatch({selection:{anchor:s}})}),l=a.emit;b(()=>e.modelValue,s=>{if(n.composing)return;const d=n.state.selection;n.dispatch({changes:{from:0,to:n.state.doc.length,insert:s},selection:d})}),b(()=>e.dark,()=>{n.dispatch({effects:W.reconfigure.of(c())})}),B(async()=>{let s=r.value;o.value&&o.value.childNodes[0]&&(r.value!==""&&console.warn("[CodeMirror.vue] The <code-mirror> tag contains child elements that overwrite the `v-model` values."),s=y.exports.trim(o.value.childNodes[0].innerText)),n=new f({doc:s,extensions:c(),parent:o.value,dispatch:d=>{n.update([d]),!d.changes.empty&&l("update:modelValue",n.state.doc.toString())}}),await E()}),O(()=>n.destroy());const c=()=>y.exports.compact([e.basic?H:void 0,e.minimal&&!e.basic?J:void 0,f.updateListener.of(d=>l("update",d)),f.theme(e.theme,{dark:e.dark}),e.wrap?f.lineWrapping:void 0,e.tab?R.of([F]):void 0,e.phrases?L.phrases.of(e.phrases):void 0,e.readonly?L.readOnly.of(e.readonly):void 0,e.editable?f.editable.of(e.editable):void 0,e.lang?A(e.lang):void 0,e.linter?G(e.linter):void 0,e.linter&&e.lintGutter?I():void 0,...e.extensions]),m=()=>n.state.selection;return{context:a,editor:o,cursor:i,selection:m,getRange:(s,d)=>n.state.sliceDoc(s,d),getLine:s=>n.state.doc.line(s+1).text,lineCount:()=>n.state.doc.lines,getCursor:()=>i.value,listSelections:()=>m().ranges,getSelection:()=>n.state.sliceDoc(m().main.from,m().main.to),getSelections:()=>m().ranges.map(s=>n.state.sliceDoc(s.from,s.to)),somethingSelected:()=>m().ranges.some(s=>!s.empty),replaceRange:(s,d,q)=>n.dispatch({changes:{from:d,to:q,insert:s}}),replaceSelection:s=>n.dispatch(n.state.replaceSelection(s)),setCursor:s=>i.value=s,setSelection:(s,d)=>n.dispatch({selection:{anchor:s,head:d}}),setSelections:(s,d)=>n.dispatch({selection:x.create(s,d)}),extendSelectionsBy:s=>n.dispatch({selection:x.create(m().ranges.map(d=>d.extend(s(d))))}),focus:()=>n.focus(),hasFocus:()=>n.hasFocus}},render(){return C("div",{ref:"editor",class:"vue-codemirror"},this.$slots.default?C("aside",{style:"display: none;","aria-hidden":"true"},te(this.$slots.default)):void 0)}});typeof window<"u"&&window.Vue&&window.Vue.use($);var T=(e,a)=>{const o=e.__vccOpts||e;for(const[r,n]of a)o[r]=n;return o};const ne=w({components:{CodeMirror:$},props:{dark:{type:Boolean,default:!1}},setup(){const e=h(`# The quick brown fox jumps over the lazy dog.
