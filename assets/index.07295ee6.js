import{h as j,d as w,r as h,c as v,w as k,o as B,n as E,a as O,t as A,b as V,e as n,f as p,g as b,i as z,v as D,j as c,k as _,l as M,m as $,p as N}from"./vue.7dc6131d.js";import{l as L}from"./lodash.e25d2325.js";import{E as g,b as H,m as J,k as R,i as G,a as x,l as I,c as W,d as C,S as F,e as P,h as K,j as Y,f as Q}from"./codemirror.4e21c11d.js";import{z as X}from"./eslint4b.fb0c667f.js";const Z=function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))r(t);new MutationObserver(t=>{for(const i of t)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function a(t){const i={};return t.integrity&&(i.integrity=t.integrity),t.referrerpolicy&&(i.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?i.credentials="include":t.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(t){if(t.ep)return;t.ep=!0;const i=a(t);fetch(t.href,i)}};Z();const ee=e=>e?Object.entries(e).reduce((s,[a,r])=>(a=a.charAt(0).toUpperCase()+a.slice(1),a=`on${a}`,{...s,[a]:r}),{}):{},S=(e,s={},a)=>{const{props:r,domProps:t,on:i,...l}=s,u=i?ee(i):{};return j(e,{...l,...r,...t,...u},a)},te=e=>typeof e=="function"?e():e,T=w({name:"CodeMirror",model:{prop:"modelValue",event:"update:modelValue"},props:{modelValue:{type:String,default:""},theme:{type:Object,default:()=>({})},dark:{type:Boolean,default:!1},basic:{type:Boolean,default:!1},minimal:{type:Boolean,default:!1},wrap:{type:Boolean,default:!1},tab:{type:Boolean,default:!1},readonly:{type:Boolean,default:!1},editable:{type:Boolean,default:!0},extensions:{type:Array,default:()=>[]},phrases:{type:Object,default:()=>{}},lang:{type:Object,default:()=>{}},linter:{type:Function,default:void 0},lintGutter:{type:Boolean,defalt:!1}},emits:["update:modelValue","update:view"],setup(e,s){const a=h(),r=h(e.modelValue);let t;const i=v({get:()=>t.state.selection,set:o=>t.dispatch({selection:o})}),l=v({get:()=>i.value.main.head||0,set:o=>t.dispatch({selection:{anchor:o}})}),u=v({get:()=>t.state,set:o=>t.setState(o)}),y=v({get:()=>t.hasFocus,set:o=>{o&&t.focus()}}),m=s.emit;k(e,o=>{if(o.modelValue){if(t.composing)return;const d=t.state.selection;t.dispatch({changes:{from:0,to:t.state.doc.length,insert:o.modelValue},selection:d})}t.dispatch({effects:F.reconfigure.of(f())})}),B(async()=>{let o=r.value;a.value&&a.value.childNodes[0]&&(r.value!==""&&console.warn("[CodeMirror.vue] The <code-mirror> tag contains child elements that overwrite the `v-model` values."),o=L.exports.trim(a.value.childNodes[0].innerText)),t=new g({doc:o,extensions:f(),parent:a.value,dispatch:d=>{t.update([d]),!d.changes.empty&&m("update:modelValue",t.state.doc.toString())}}),await E()}),O(()=>t.destroy());const f=()=>L.exports.compact([e.basic?H:void 0,e.minimal&&!e.basic?J:void 0,g.updateListener.of(d=>m("update:view",d)),g.theme(e.theme,{dark:e.dark}),e.wrap?g.lineWrapping:void 0,e.tab?R.of([G]):void 0,e.phrases?x.phrases.of(e.phrases):void 0,e.readonly?x.readOnly.of(e.readonly):void 0,e.editable?g.editable.of(e.editable):void 0,e.lang?A(e.lang):void 0,e.linter?I(e.linter):void 0,e.linter&&e.lintGutter?W():void 0,...e.extensions]);return{context:s,editor:a,cursor:l,selection:i,state:u,focus:y,getRange:(o,d)=>t.state.sliceDoc(o,d),getLine:o=>t.state.doc.line(o+1).text,lineCount:()=>t.state.doc.lines,getCursor:()=>l.value,listSelections:()=>t.state.selection.ranges,getSelection:()=>t.state.sliceDoc(t.state.selection.main.from,t.state.selection.main.to),getSelections:()=>t.state.selection.ranges.map(o=>t.state.sliceDoc(o.from,o.to)),somethingSelected:()=>t.state.selection.ranges.some(o=>!o.empty),replaceRange:(o,d,U)=>t.dispatch({changes:{from:d,to:U,insert:o}}),replaceSelection:o=>t.dispatch(t.state.replaceSelection(o)),setCursor:o=>l.value=o,setSelection:(o,d)=>t.dispatch({selection:{anchor:o,head:d}}),setSelections:(o,d)=>t.dispatch({selection:C.create(o,d)}),extendSelectionsBy:o=>t.dispatch({selection:C.create(i.value.ranges.map(d=>d.extend(o(d))))})}},render(){return S("div",{ref:"editor",class:"vue-codemirror"},this.$slots.default?S("aside",{style:"display: none;","aria-hidden":"true"},te(this.$slots.default)):void 0)}});typeof window<"u"&&window.Vue&&window.Vue.use(T);const q=(e,s)=>{const a=e.__vccOpts||e;for(const[r,t]of s)a[r]=t;return a},ne=w({components:{CodeMirror:T},props:{dark:{type:Boolean,default:!1}},setup(){const e=h(`# The quick brown fox jumps over the lazy dog.
