...
`,ne={class:`row`},re={class:`col-6`},ie={class:`row mb-3`},ae={class:`col-4`},oe={class:`input-group`},se=[`value`],ce={class:`col-5`},le={class:`input-group`},ue=[`value`],de={class:`col-3`},fe={class:`form-check form-check-inline`},pe={class:`col-6`},me=d({__name:`LinterAndCrossBindingDemo`,props:{dark:{type:Boolean}},setup(e){let t=n(),i=n(`document.querySelectorAll('.btn').forEach(
  element => ああああelement.addEventListner('click', alert('あああああ'));
);`),a=n(!1),o=B(new K.Linter,{languageOptions:{parserOptions:{ecmaVersion:2022,sourceType:`module`}},rules:{semi:[`error`,`never`]}}),s=e=>{a.value=e};return(n,c)=>(b(),u(g,null,[m(`div`,ne,[m(`div`,re,[f(r(X),{ref_key:`cm`,ref:t,modelValue:i.value,"onUpdate:modelValue":c[0]||=e=>i.value=e,dark:e.dark,lang:r(U)(),linter:r(o),class:`mb-3`,basic:``,gutter:``,wrap:``,onFocus:s},null,8,[`modelValue`,`dark`,`lang`,`linter`]),m(`div`,ie,[m(`div`,ae,[m(`div`,oe,[c[3]||=m(`label`,{for:`count`,class:`input-group-text`},`Count`,-1),m(`input`,{id:`count`,value:t.value?.length,type:`text`,class:`form-control`,readonly:``},null,8,se)])]),m(`div`,ce,[m(`div`,le,[c[4]||=m(`label`,{for:`diagnosticCount`,class:`input-group-text`},` Diagnostic Count `,-1),m(`input`,{id:`diagnosticCount`,value:t.value?.diagnosticCount,type:`number`,class:`form-control`,readonly:``},null,8,ue)])]),m(`div`,de,[m(`div`,fe,[y(m(`input`,{id:`focused`,"onUpdate:modelValue":c[1]||=e=>a.value=e,class:`form-check-input`,type:`checkbox`,checked:``,disabled:``},null,512),[[C,a.value]]),c[5]||=m(`label`,{class:`form-check-label`,for:`focused`},`Focused`,-1)])])])]),m(`div`,pe,[y(m(`textarea`,{"onUpdate:modelValue":c[2]||=e=>i.value=e,rows:`4`,class:`form-control`},null,512),[[S,i.value]])])]),c[6]||=m(`p`,null,[m(`kbd`,null,`Ctrl-Shift-m`),h(` ( `),m(`kbd`,null,`Cmd-Shift-m`),h(` on macOS) to show lint panel. `),m(`kbd`,null,`F8`),h(` key shows the next error. `)],-1)],64))}}),he=`<script setup lang="ts">
...
`,ge={class:`row`},_e={class:`col-6`},ve={class:`col-6`},ye=d({__name:`MarkdownDemo`,props:{dark:{type:Boolean}},setup(e){let t=n(`# The quick brown fox jumps over the lazy dog.

[Lorem ipsum](https://www.lipsum.com/) dolor sit amet, **consectetur** adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.`);return(n,i)=>(b(),u(`div`,ge,[m(`div`,_e,[f(r(X),{ref:`cm`,modelValue:t.value,"onUpdate:modelValue":i[0]||=e=>t.value=e,dark:e.dark,lang:r(W)(),wrap:``,basic:``},null,8,[`modelValue`,`dark`,`lang`])]),m(`div`,ve,[f(r(w),{modelValue:t.value,"onUpdate:modelValue":i[1]||=e=>t.value=e,"data-color-mode":e.dark?`dark`:`light`,class:`markdown-body`},null,8,[`modelValue`,`data-color-mode`])])]))}}),be=`<script setup lang="ts">
import { ref, type Ref } from 'vue';
...
`,xe={class:`form-check form-switch`},Se=[`aria-checked`],Ce={class:`form-check form-switch`},we=[`aria-checked`],Te=d({__name:`ReadonlyAndDisabledDemo`,props:{dark:{type:Boolean}},setup(t){let i=n(!0),a=n(!1);return(n,o)=>(b(),u(g,null,[m(`div`,xe,[y(m(`input`,{id:`readonly`,"onUpdate:modelValue":o[0]||=e=>i.value=e,"aria-checked":i.value,type:`checkbox`,class:`form-check-input`,role:`switch`},null,8,Se),[[C,i.value]]),o[2]||=m(`label`,{class:`form-check-label`,for:`readonly`},`Readonly`,-1)]),m(`div`,Ce,[y(m(`input`,{id:`disabled`,"onUpdate:modelValue":o[1]||=e=>a.value=e,"aria-checked":a.value,type:`checkbox`,class:`form-check-input`,role:`switch`},null,8,we),[[C,a.value]]),o[3]||=m(`label`,{class:`form-check-label`,for:`disabled`},`Disabled`,-1)]),f(r(X),{dark:t.dark,readonly:i.value,disabled:a.value,basic:``},{default:e(()=>[...o[4]||=[m(`pre`,null,`色は匂へど　散りぬるを
我が世誰そ　常ならむ
有為の奥山　今日越えて
...
`,De=d({__name:`SlotDemo`,props:{dark:{type:Boolean}},setup(t){return(n,i)=>(b(),v(r(X),{dark:t.dark,lang:r(G)(),linter:r(H)(),basic:``,readonly:``},{default:e(()=>[...i[0]||=[m(`pre`,null,`{
